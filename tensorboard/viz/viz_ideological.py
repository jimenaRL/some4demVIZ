...
targets = pd.read_csv(os.path.join(embeddings, 'ide_targets.csv'))
targets_names = pd.read_csv(os.path.join(embeddings, 'mps_metadata.csv'))
targets_groups = pd.read_csv(os.path.join(embeddings, 'targets_groups.csv'))
...
sources = pd.read_csv(os.path.join(embeddings, 'ide_sources.csv'))
